    ...
    if (editingTheme) {
      ...
      const result = await updateTheme(editingTheme.id, {
        colors: {
          ...
          accent_tertiary: palette.roles.accent_tertiary,
          accent_quaternary: palette.roles.accent_quaternary,
        },
        ...
        if (result.success && result.filePath) {
          ...
          const savedTheme: SavedTheme = {
            ...
            colors: {
              ...
              accent_tertiary: pendingTheme.palette.roles.accent_tertiary,
              accent_quaternary: pendingTheme.palette.roles.accent_quaternary,
            },
